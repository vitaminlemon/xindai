...
<html xml:lang="en" xmlns="http://www.w3.org/1999/xhtml" lang="en"><head>
  ...
  <script language="javascript" src="js/sanweiyifen.js"></script>
	...
	<form action="servlet/DisplaySdkhxxServlet" method="get" name="sampleform">
	<div id="frame">
		<div id="header">
			<div id="signoutlink">
			    	...
			    	<td>
			    		...
			    		<%  
							...
							for(Sdkhxx a : list){
								...
								+"<tr><td>"+"属总行直接经营客户："+"</td><td>"
								+"<input type='text' name='jykh' value="+a.getJykh()+">"+"</td><td>"
								+"是否为上市公司："+"</td><td>"
								+"<input type='text' name='ssgs' value="+a.getSsgs()+">"+"</td></tr>"
